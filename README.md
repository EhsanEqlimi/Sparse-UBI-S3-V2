...
1. [Multiple Sparse Component Analysis Based on Subspace Selective Search Algorithm](link_to_paper_1) by E. Eqlimi and B. Makkiabadi, presented at the 2015 23rd Iranian Conference on Electrical Engineering.

2. [An Efficient K-SCA Based Underdetermined Channel Identification Algorithm for Online Applications](link_to_paper_2) by E. Eqlimi and B. Makkiabadi, presented at the 2015 23rd European Signal Processing Conference (EUSIPCO).
...
- Ehsan Eqlimi: [email@example.com](mailto:email@example.com)
